...
public class Scp {
    ...
    private void parseCLine(String line, FileInfo fileInfo) throws IOException {
    ...
    private void parseTLine(String line, FileInfo fileInfo) throws IOException {
     ...
     *             in case of network problems
     */
    public void get(String remoteFile, String localTarget) throws IOException {
